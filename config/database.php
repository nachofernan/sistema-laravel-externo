    ...
    */
    ...
    'connections' => [
        ...
        'proveedores' => [
            ...
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE_PROVEEDORES', 'laravel'),
            'username' => env('DB_USERNAME_PROVEEDORES', 'root'),
        ...
        'concursos' => [
            ...
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE_CONCURSOS', 'laravel'),
            'username' => env('DB_USERNAME_CONCURSOS', 'root'),
